...
@Entity
@Table(name="ADMON_EXAMEN_HDR")
@NamedQuery(name="AdmonExamenHdrDto.findAll", query="SELECT a FROM AdmonExamenHdrDto a")
public class AdmonExamenHdrDto implements Serializable {
