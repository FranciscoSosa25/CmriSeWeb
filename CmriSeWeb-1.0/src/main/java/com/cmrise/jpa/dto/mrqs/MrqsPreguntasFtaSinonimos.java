...
@Entity
@Table(name="MRQS_PREGUNTAS_FTA_SINONIMOS")
public class MrqsPreguntasFtaSinonimos implements Serializable {
	...
	public MrqsPreguntasFtaSinonimos() {}
	public MrqsPreguntasFtaSinonimos(String textoSinonimo){
