    ...
    */
    ...
    for (var i = 0; i < perimeter.length; i++) {
        if (i == 0) {
            ...
            console.log("ctx.moveTo : "+ctx.moveTo);
        } else {
            ctx.lineTo(perimeter[i]['x'], perimeter[i]['y']);
            console.log("ctx.lineTo : "+ctx.lineTo);
        }
    }
...
function draw(end) {
    ...
    if (perimeter.length == 0) {
        document.getElementById('UpdateReactivosForm:coordinates').value = '';
        console.log("document.getElementById('UpdateReactivosForm:coordinates').value : "+document.getElementById('UpdateReactivosForm:coordinates').value);
    } else {
...
function loadPolygon(reset = false) {
    ...
    if (!reset) {
        ...
        console.log("polygonData loadtime: "+polygonData);

        json = polygonData && polygonData !== '' ? JSON.parse(polygonData) : {};
        console.log("polygonData json : "+JSON.stringify(json));
    }
...
function savePolygon() {
    ...
    console.log("savePolygon() : "+polygonData);
