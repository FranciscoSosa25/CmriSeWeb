...
@Entity
@Table(name="CAND_EXAM_SKIP_V1")
@NamedQuery(name="CandExamSkipV1Dto.findAll", query="SELECT c FROM CandExamSkipV1Dto c")
public class CandExamSkipV1Dto implements Serializable {
	...
	public void setExamen(long pExamen) {
		examen = pExamen;
	}
