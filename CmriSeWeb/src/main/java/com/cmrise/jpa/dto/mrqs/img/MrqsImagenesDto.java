...
@Entity
@Table(name="MRQS_IMAGENES")
@NamedQuery(name="MrqsImagenesDto.findAll", query="SELECT m FROM MrqsImagenesDto m")
public class MrqsImagenesDto implements Serializable {
